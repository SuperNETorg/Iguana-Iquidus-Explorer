...
Client.prototype.call = function(method, params, callback, errback, path) {
  ...
  request.on('response', function(response) {
    ...
    response.on('data', function(chunk) {
      buffer = buffer + chunk;
      console.log("recieved data: "+buffer);
    });
    ...
    response.on('end', function() {
      ...
      try {
        var decoded = JSON.parse(buffer);
           ...
           console.log("Cought exception here!!");
      ...
      decoded.forEach(function(decodedResponse, i) {
        ...
        if (decodedResponse.hasOwnProperty('error') && decodedResponse.error != null) {
        ...
        } else if (decodedResponse.hasOwnProperty('result') && decodedResponse.hasOwnProperty('proof-of-work')  ) {
          if (callback) {
            callback({"nonStandard":true,data:decodedResponse['proof-of-work']});
          }
        }
        else if ( (decodedResponse.hasOwnProperty('result') && decodedResponse.hasOwnProperty('previousblockhash'))  || ((decodedResponse.hasOwnProperty('vin') && decodedResponse.hasOwnProperty('vout'))))  {
          if (callback) {
          ...
          /*if (errback) {
            ...
            if (callback) {
            callback({"nonStandard":true,data:decodedResponse});
          }  
        }
      });
