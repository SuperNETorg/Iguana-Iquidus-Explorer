...
module.exports = {
  ...
  get_difficulty: function(cb) {
    ...
    request({uri: uri, json: true}, function (error, response, body) {
        var difficulty={};
        if(body.nonStandard){
        difficulty['proof-of-work']=body.data;
        difficulty['proof-of-stake']=body.data;
        return cb(difficulty);
    }else{
              return cb(body);
    }
  ...
  get_connectioncount: function(cb) {
    ...
    request({uri: uri, json: true}, function (error, response, body) {
      var connectioncount={};
        if(body.nonStandard){
        connectioncount=body.data;
        
        return cb(connectioncount);
    }else{
              return cb(body);
    }
    });
  ...
  get_blockcount: function(cb) {
    ...
    request({uri: uri, json: true}, function (error, response, body) {
      var blockcount={};
        if(body.nonStandard){
        blockcount=body.data;
        
        return cb(blockcount);
    }else{
              return cb(body);
    }
    });
  ...
  get_rawtransaction: function(hash, cb) {
    ...
    request({uri: uri, json: true}, function (error, response, body) {
      var rawtransaction={};
        if(body.nonStandard){
        rawtransaction=body.data;
        
        return cb(rawtransaction);
    }else{
              return cb(body);
    }
    });
